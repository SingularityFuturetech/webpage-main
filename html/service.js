...
<div class="container_of_product">
   <div class="container_product">
   <div class="title_product">Just anything you need</div>
   <div class="subtitle_product"> </div>
 </div>
 </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="service-wrap text-center">
                     ...
                     <h3>Brilliant Warehouse</h3>
                     <p>
                     EIntegrated global logistic services.                     </p>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="service-wrap text-center">
                     ...
                     <h3>Mining Farm</h3>
                     <p>Mining with top-notch machinery.</p>
               </div>
            </div>
         </div>
      </section>
